      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold text-indigo-600">SHORTBOOSTER</span>
          </div>
          <h1 className="text-xl font-semibold text-gray-700">Creative Analyzer</h1>
        </div>

        {/* ログインフォーム */}
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-6">ログイン</h2>
